...
class tfrecord_s1_scene():
    '''
    write and parse the tfrecord file which stored the image scene data.
    '''
    ...
    ##############################################
    ### for the parsing of the tfrecord files. 
    ...
    def toScenePair(self, inputs):
        ...
        outputs: 1) image scene of the feature bands, 2) image scene of the truth band.
        '''
...
class tfrecord_s1_patch():
    '''
    write and parse the tfrecord file which stored the image patch data.
    this class is designed for the evaluation data writing and parsing.
    '''
